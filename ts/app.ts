...
function wireEvents(): void {
   ...
   let dugmeDodaj = document.getElementById('dodajIspit');
   ...
   dugmeDodaj.addEventListener('click',() => {
       ...
       let jmbg = (document.getElementById('jmbg') as HTMLInputElement).value;
       let datum = (document.getElementById('datum') as HTMLInputElement).value;
       let bodoviTeorija = (document.getElementById('teorija') as HTMLInputElement).value;
       let bodoviPrakticno = 
       (document.getElementById('prakticno') as HTMLInputElement).value;

       let objTeorija = new Ispit(aktivanInstruktor,ime,prezime,Number(jmbg),'Teorija',datum,Number(bodoviTeorija));

       let objPrakticno = new Ispit(aktivanInstruktor,ime,prezime,Number(jmbg),'Prakticno',datum,Number(bodoviPrakticno));
   ...
   let najslabiji = document.getElementById('najslabijiKandidatPoInstruktoruZaNacinPolaganja');
   

   najslabiji.addEventListener('click',() => {
    let vrednost = (document.getElementById('nacinPolaganjaSelekt') as HTMLInputElement).value;
       autoSkola.najslabijiKandidatPoInstruktoru(vrednost,aktivanInstruktor);
   });



   let najboljiInstruktor: HTMLElement = document.getElementById('najboljiInstruktoriPoNacinuPolaganja');

   najboljiInstruktor.addEventListener('click', () => {
